...
([source](https://github.com/rocker-org/rocker))
    * r-base, r-tidyverse, rocker/tidyverse:3.3.1
    ...
    ```
    docker run -it --rm -p 8787:8787 rocker/tidyverse
    ```

    The username and password are both "rstudio". For anyone else reading this,
    that means you should only run this on your local machine. Never expose this
    online since it is obviously super insecure.
